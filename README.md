...
⚡ Quick Demo
🐍 Python
pythonfrom datagen import generate
...
print(df)
💻 CLI
bashdatagen generate schema.json --rows 100 --output data.csv
🧾 Example Output
        name   age    salary
...
🚀 Installation
bashpip install datagen

💻 CLI Commands
CommandDescriptiongenerateGenerate datasetpreviewPreview sample datavalidateValidate schema
...
🤝 Contributing
bashgit clone https://github.com/your-username/datagen-cli
cd datagen-cli
